...
I’ve developed applications like a to-do list and a quiz app where I focused on DOM manipulation, user interaction, and clean UI design. I’ve also built a portfolio using React to understand component-based architecture and state management.</p>

<p className="text-justify mt-3">Currently, I’m strengthening both my problem-solving skills and communication skills to become industry-ready.
